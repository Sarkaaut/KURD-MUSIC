...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/ifkkyccb")
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/sjgsusjsvs")

SUDO_USERS = list(map(int, getenv("SUDO_USERS", "6173031600").split()))
